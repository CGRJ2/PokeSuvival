...
public class PlayerModel : PokeBaseData
{
	...
	public override void SetCurrentHp(int hp) => CurrentHp = hp;
	...
	public override void SetSkillCooldown(SkillSlot slot, float cooldown)
	{
		base.SetSkillCooldown(slot, cooldown);
    ...
    public int GetDeathExp()
	{
        ...
        return Mathf.RoundToInt(TotalExp * modifyValue);
    }
}
